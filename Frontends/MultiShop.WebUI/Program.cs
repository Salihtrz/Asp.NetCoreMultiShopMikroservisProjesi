...
using MultiShop.WebUI.Services.CargoCompanyServices.CargoCompanyServices;
...
//builder.Services.Configure<oluþturulan ilgili sýnýf>(builder.Configuration.GetSection("appsettings.json da kullanýlan isim"));
...
var localicationOptions = new RequestLocalizationOptions().SetDefaultCulture(supportedCultures[3]).AddSupportedCultures(supportedCultures).AddSupportedUICultures(supportedCultures);
