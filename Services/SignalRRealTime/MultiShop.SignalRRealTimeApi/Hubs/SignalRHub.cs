...
namespace MultiShop.SignalRRealTimeApi.Hubs
{
    public class SignalRHub : Hub
    {
        ...
        public async Task SendStatisticCount()
        {
            ...
            //var getTotalMesasageCount = _signalRMessageService.GetTotalMessageCountByReceiverId(id);
            //await Clients.All.SendAsync("ReceiveMessageCount", getTotalMesasageCount);
        }
